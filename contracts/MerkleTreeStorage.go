...
func (_MerkleTreeStorage *MerkleTreeStorageTransactor) StoreTree(opts *bind.TransactOpts, merkleRoot [32]byte, leaves [][]byte) (*types.Transaction, error) {
...
//
// Solidity: function storeTree(bytes32 merkleRoot, bytes[] leaves) returns(bytes32)
func (_MerkleTreeStorage *MerkleTreeStorageSession) StoreTree(merkleRoot [32]byte, leaves [][]byte) (*types.Transaction, error) {
...
//
// Solidity: function storeTree(bytes32 merkleRoot, bytes[] leaves) returns(bytes32)
func (_MerkleTreeStorage *MerkleTreeStorageTransactorSession) StoreTree(merkleRoot [32]byte, leaves [][]byte) (*types.Transaction, error) {
	return _MerkleTreeStorage.Contract.StoreTree(&_MerkleTreeStorage.TransactOpts, merkleRoot, leaves)
}
